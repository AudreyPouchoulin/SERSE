...
<body>
		...
		<table>
			...
			<tr>
				...
				<td><select name="continent" id="continent">
						<option value="defaut" selected="selected">Choisissez un
							continent</option>
			...
			<tr>
				...
				<td id='autrePays' style="display: none"><input
					id="valueAutrePays" type="text" placeholder="Nom du pays ?" /></td>
			</tr>
			...
			<tr>
				<td>Ville</td>
				<td><select id="ville">
						<option value="defaut" selected="selected">Choisissez une
							ville</option>
						<!-- available options are filled by AJAJ -->
				</select></td>
				<td id='autreVille' style="display: none"><input
					id="valueAutreVille" type="text" placeholder="Nom de la ville ?" />
				</td>
			</tr>
			...
			<tr>
				...
				<td><select id="typeSejour">
						<option value="defaut" selected="selected">Choisissez un
							type de séjour</option>
						<!-- available options are filled by AJAJ -->
				</select></td>
			</tr>
			...
			<tr>
				...
				<td><select id="typeMobilite">
						<option value="defaut" selected="selected">Choisissez un
							type de mobilité</option>
						<!-- available options are filled by AJAJ -->
				</select></td>
			</tr>
			...
			<tr>
				...
				<td><select id="typeExperience">
						<option value="defaut" selected="selected">Choisissez un
							type d'expérience</option>
						<!-- available options are filled by AJAJ -->
				</select></td>
			</tr>
			...
			<tr>
				...
				<td><select id="universite_entreprise">
						<option value="defaut" selected="selected">Choisissez une
							université ou une entreprise</option>
						<optgroup id="universiteGroup" label="Universite">Université
						</optgroup>
						<!-- available options are filled by AJAJ -->
						<optgroup id="entrepriseGroup" label="Entreprise">Entreprise
						</optgroup>
						<!-- available options are filled by AJAJ -->
				</select></td>
				<td id='autreUniversite' style="display: none"><input
					id="valueAutreUniversite" type="text"
					placeholder="Nom de l'université ?" /></td>
				<td id='autreEntreprise' style="display: none"><input
					id="valueAutreEntreprise" type="text"
			...
			<tr>
				...
				<td><select id="langue">
						<option value="defaut" selected="selected">Choisissez une
							langue de travail majoritaire</option>
						<!-- available options are filled by AJAJ -->
				</select> <img src="images/iconeInformation.jpg" height="12%" width="5%"
					class="imageflottante"></td>
				<td id='autreLangue' style="display: none"><input
					id="valueAutreLangue" type="text" placeholder="Nom de la langue ?" />
				</td>
			</tr>
			...
			<tr>
				...
				<td><select id="domaine">
						<option value="defaut" selected="selected">Choisissez un
							domaine d'activité principal</option>
						<!-- available options are filled by AJAJ -->
				</select> <img src="images/iconeInformation.jpg" height="12%" width="5%"
					class="imageflottante"></td>
				<td id='autreDomaine' style="display: none"><input
					id="valueAutreDomaine" type="text"
					placeholder="Nom du domaine d'activité ?" /></td>
			</tr>

			<!--Adresse du lieu de séjour-->
			<tr>
				<td>Adresse du lieu de séjour</td>
				<td><input id="adresse" type="text"
					placeholder="Entrer l'adresse du lieu de séjour" size="27"></td>
			...
			<tr>
				...
				<td id="coordonnees">Lancer la recherche apres avoir saisi
					l'adresse
				<td>
			</tr>
	...
	<div id="dialogConfirmation" title="Confirmation de soumission de rapport" style='display: none'>
		<p id='informationsDeSoumission'>
