...
public class RecherchesRequetesController {
	...
	/** Controleur de base de donn√©es */
	protected BddController bdd;
	
	/**
	 * Initialise un controlleur d'options
	 * @param bdd : Base de donn√©es √† utiliser
	 */
	...
	/**
	 * Permet d'obtenir le nombre de rapports venant d'Ítres mis en lignes
	 * @return integer
	...
	/**
	 * Permet d'obtenir les rapports ‡ valider
	 * @return integer
	 * @throws DatabaseException
	 * @throws SQLException
	 */
